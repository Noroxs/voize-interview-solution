...
android {
    namespace = "org.example.voize.patientdataapp"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.example.voize.patientdataapp"
...
compose.desktop {
    application {
        mainClass = "org.example.voize.patientdataapp.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "org.example.voize.patientdataapp"
